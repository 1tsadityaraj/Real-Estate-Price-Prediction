...
- **Dataset Size:** The model was trained on 440 property records, limiting its ability to achieve production-grade precision (which typically requires hundreds of thousands of entries).
