 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Price Distribution\n",
    "sns.histplot(df['Price_INR'], kde=True, ax=axes[0], color='blue')\n",
    "axes[0].set_title('Distribution of Property Prices')\n",
    "axes[0].set_xlabel('Price in INR')\n",
    "\n",
    "# Area Distribution\n",
    "sns.histplot(df['Area_sqft'], kde=True, ax=axes[1], color='green')\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "# Area vs Price\n",
    "sns.scatterplot(data=df, x='Area_sqft', y='Price_INR', ax=axes[0], alpha=0.6)\n",
    "axes[0].set_title('Area vs Property Price')\n",
    "axes[0].set_xlabel('Area (sqft)')\n",
    "axes[0].set_ylabel('Price (INR)')\n",
    "\n",
    "# Area vs Price per sqft\n",
    "sns.scatterplot(data=df, x='Area_sqft', y='price_per_sqft', ax=axes[1], alpha=0.6, color='purple')\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "sns.boxplot(data=df, x='BHK', y='Price_INR', ax=axes[1], palette='viridis')\n",
    "axes[1].set_title('BHK vs Price')\n",
    "\n",
    "sns.boxplot(data=df, x='BHK', y='Area_sqft', ax=axes[2], palette='viridis')\n",
  ...
  },
  {
   ...
   "source": [
    "fig, axes = plt.subplots(1, 2, figsize=(15, 5))\n",
    "\n",
    "sns.boxplot(data=df, x='Property_Type', y='Price_INR', ax=axes[0], palette='Set2')\n",
    "axes[0].set_title('Property Type vs Price')\n",
    "\n",
    "sns.boxplot(data=df, x='Bathrooms', y='Price_INR', ax=axes[1], palette='Set3')\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "sns.boxplot(data=df, x='Price_INR', ax=axes[0, 0], color='cyan')\n",
    "axes[0, 0].set_title('Price Outliers')\n",
    "\n",
    "sns.boxplot(data=df, x='Area_sqft', ax=axes[0, 1], color='magenta')\n",
    "axes[0, 1].set_title('Area Outliers')\n",
    "\n",
    "sns.boxplot(data=df, x='BHK', ax=axes[1, 0], color='yellow')\n",
    "axes[1, 0].set_title('BHK Outliers')\n",
    "\n",
    "sns.boxplot(data=df, x='price_per_sqft', ax=axes[1, 1], color='lime')\n",
